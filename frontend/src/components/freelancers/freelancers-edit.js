...
export class FreelancersEdit {
    ...
    educationInputElement = null;
    locationInputElement = null;
    skillsInputElement = null;
    infoInputElement = null;
    levelSelectElement = null;
    freelancerOriginalData = null;
    avatarInputElement = null;
    validations = null;
    ...
    findElements() {
        ...
        this.avatarInputElement = document.getElementById('avatar');
    }
    ...
    showFreelancer(freelancer) {
        ...
        if (freelancer.avatar) {
            this.avatarInputElement.src = config.host + freelancer.avatar;
        }
